	...
	app.displayInfo = function(data) {
		...
		var length = translation.length;
			if (length >= 7) {
				$('header h2').css('font-size', '120px');
			};
		$('.text').addClass('animated fadeIn').text(translation);
		app.speak(translation);
	...
	app.speak = function(phrase) {
			var fullUrl = app.speechUrl + "/?key=" + app.speechKey + "&hl=zh-cn&r=-5&f=16khz_16bit_mono&src=" + phrase; 
